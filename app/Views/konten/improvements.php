<div class="card shadow-none position-relative overflow-hidden mb-4">
    <div class="card-body d-flex align-items-center justify-content-between p-4">
        <div>
            <h4 class="fw-semibold mb-0">Improvement</h4>
            <small class="text-muted">KPI Multimedia — Improvement 5% (ide perbaikan yang disetujui / bulan). Target: 1 per bulan.</small>
        </div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a class="text-muted text-decoration-none" href="<?= base_url('konten') ?>">Manajemen Konten</a></li>
                <li class="breadcrumb-item active">Improvement</li>
            </ol>
        </nav>
    </div>
</div>
