            ...
            <div class="col-md-4">
                    ...
                    <select
                        ...
                        <?php foreach($list_karyawan as $karyawan): ?>
                            ...
                            <option
                                value="<?= $karyawan['ID_AKUN'] ?>"
                                <?= $selected_karyawan == $karyawan['ID_AKUN'] ? 'selected' : '' ?>>
                    ...
                    <div class="card bg-primary-subtle border-0">
                        ...
                        <div class="card-body">
                            ...
                            <h1 class="fw-bold text-primary">
                                <?= number_format($aktual_omset_unit[1]+$aktual_omset_unit[2]+$aktual_omset_unit[3]+$aktual_omset_unit[4], 0, ',', '.') ?>
                            </h1>
                ...
                <div class="col-md-4">
                    <div class="card bg-primary-subtle border-0">
                        ...
                        <div class="card-body">
                            ...
                            <h7 class="fw-bold text-primary">
                                Omset Probolinggo : Rp <?= number_format($aktual_omset_unit[1], 0, ',', '.') ?>
                            </h7>
                            
                            <br>

                            <h7 class="fw-bold text-primary">
                                Omset Jember : Rp <?= number_format($aktual_omset_unit[2], 0, ',', '.') ?>
                            </h7>

                            <br>

                            <h7 class="fw-bold text-primary">
                                Omset Banyuwangi : Rp <?= number_format($aktual_omset_unit[3], 0, ',', '.') ?>
                            </h7>
                            
                            <br>

                            <h7 class="fw-bold text-primary">
                                Omset Pandaan : Rp <?= number_format($aktual_omset_unit[4], 0, ',', '.') ?>
                            </h7>
