...
<form action="<?php echo base_url('update/pelanggan_service_garansi') ?>" enctype="multipart/form-data" method="post">
    <div class="row g-3">
        ...
        <div class="col-md-6">
            ...
            <select class="form-select js-domisili" id="form_provinsi" name="domisili_provinsi" disabled>
        ...
        <div class="col-md-6">
            ...
            <select class="form-select js-domisili" id="form_kabupaten" name="domisili_kabupaten" disabled>
        ...
        <div class="col-md-6">
            ...
            <select class="form-select js-domisili" id="form_kecamatan" name="domisili_kecamatan" disabled>
