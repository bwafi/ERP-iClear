...
class KPIConfigurationSeeder extends Seeder
{
    ...
    private function seedKPIComponents()
    {
        $data = [
            ...
            // ── KPI Area Supervisor / SPV (7 komponen) ──────────────
            [
                'code' => 'OMZET_WILAYAH',
                'name' => 'Omzet Wilayah',
    ...
    private function seedKPIWeights()
    {
        ...
        $data = [
            ...
            // SPV / Area Supervisor (40) — 7 komponen area (total bobot 100%)
            ['kpi_component_id' => $componentMap['OMZET_WILAYAH'],          'position_id' => 40, 'weight' => 20, 'weight_group' => 'kpi', 'effective_from' => '2024-01-01', 'effective_to' => NULL, 'created_by' => NULL],
            ['kpi_component_id' => $componentMap['TARGET_CABANG'],          'position_id' => 40, 'weight' => 15, 'weight_group' => 'kpi', 'effective_from' => '2024-01-01', 'effective_to' => NULL, 'created_by' => NULL],
            ['kpi_component_id' => $componentMap['PRODUKTIVITAS_CABANG'],   'position_id' => 40, 'weight' => 15, 'weight_group' => 'kpi', 'effective_from' => '2024-01-01', 'effective_to' => NULL, 'created_by' => NULL],
            ['kpi_component_id' => $componentMap['SOP'],                    'position_id' => 40, 'weight' => 15, 'weight_group' => 'kpi', 'effective_from' => '2024-01-01', 'effective_to' => NULL, 'created_by' => NULL],
