...
/**
 * Menu "Campaign Digital Marketing" di grup Digital Marketing (10040).
 * Khusus Digital Marketing (jabatan 43) — terpisah dari campaign Multimedia.
 * Non-destruktif: insert jika belum ada + tambah role idmenu untuk jabatan target.
 */
class AddCampaignDigitalMarketingMenu extends Migration
{
